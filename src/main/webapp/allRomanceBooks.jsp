...
<html>
<head>
    <title>LIBRARY: ALL ROMANCE BOOKS</title>
...
<div class="container-fluid">
    <div class="row p-3">
        <c:forEach var="book" items="${romanceBook}">
            <div class="col-md-3">
                <div class="card crd-ho mt-2">
                    <div class="card-body text-center ">
                        ...
                        <p><strong><fmt:message key="language.author"/> </strong> ${book.authorFirstName} ${book.authorLastName}</p>
                        <p><strong><fmt:message key="language.genre"/> </strong> ${book.genreName}</p>
                        <p><strong><fmt:message key="language.publishingHouse"/> </strong>${book.publishingHouseName}</p>
                        ...
                        <div class="row text-center m-lg-2">
                            ...
                            <c:if test="${not empty user}">
                                <a href="${pageContext.request.contextPath}/user/cart?bookId=${book.id}&&userId=${user.id}"
                                   ...
                                   style="width: max-content"><i class="fas fa-cart-plus m-lg-1"></i><fmt:message key="language.addCart"/> </a>
                            </c:if>

                            <a href="viewBook?bookId=${book.id}" class="btn btn-success btn-sm m-lg-1"
                               style="width: auto"><i class="fa-solid fa-file-circle-info"></i><fmt:message key="language.viewDetails"/> </a>
