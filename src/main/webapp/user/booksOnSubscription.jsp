...
<html>
<head>
    <title>USER: BOOKS ON SUBSCRIPTION</title>
        ...
        <div class="row">
            <div class="col">
                <div class="card paint-card">
                    <div class="card-body">
                        <p class="fs-6-bold text-center text-black"><fmt:message
                                key="language.booksOnSubscription"/></p>
                        <table class="table table-striped">
                            ...
                            <c:forEach var="order" items="${receipts}">
                                <tr>
