...
<div class="container-fluid p-3 bg-light">
    <div class="row">
        ...
        <div class="col-md-3">
            <a href="../login.jsp" class="btn btn-success"><i class="fa-solid fa-user-plus m-lg-1"></i>${admin.name}
            </a>
...
<nav class="navbar navbar-expand-lg bg-dark bg-primary ">
    <div class="container-fluid">
        <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/admin/adminHome.jsp"><i
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page"
                       href="${pageContext.request.contextPath}/admin/adminHome.jsp"><fmt:message key="language.home"/></a>
                </li>
            </ul>
        </div>
    </div>
